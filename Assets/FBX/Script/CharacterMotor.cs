...
public class CharacterMotor : MonoBehaviour {
	...
	public class CharacterMotorMovement
	{
		...
		public float maxSidewaysSpeed = 4.0f;
		public float maxBackwardsSpeed = 4.0f;
	...
	void Start () {
		NotificationCenter.DefaultCenter.AddObserver(this, "FlagJumpingBegin");
		NotificationCenter.DefaultCenter.AddObserver(this, "FlagJumpingEnd");
		NotificationCenter.DefaultCenter.AddObserver(this, "FlagRunBegin");
		NotificationCenter.DefaultCenter.AddObserver(this, "FlagRunEnd");
	}

	void FlagJumpingBegin()
	{
		jumping.baseHeight = 3.0f;
		jumping.extraHeight = 3.0f;
	}
	void FlagJumpingEnd()
	{
		jumping.baseHeight = 1.0f;
		jumping.extraHeight = 1.0f;
	}
	void FlagRunBegin()
	{
			movement.maxForwardSpeed = 8.0f;
			movement.maxSidewaysSpeed = 7.0f;
			movement.maxBackwardsSpeed = 7.0f;
	}
	void FlagRunEnd()
	{
